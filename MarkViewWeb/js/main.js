...
`;
    ...
    let initScrollBarSync = (settings) => {
        ...
        editElement.addEventListener('scroll', () => {
            if (!scrollBarSync) {
                return;
            }
            let ratio = editElement.scrollTop / (editElement.scrollHeight - editElement.clientHeight);
            let targetY = ratio * (previewElement.scrollHeight - previewElement.clientHeight);
        ...
        previewElement.addEventListener('scroll', () => {
            ...
            let targetY = ratio * (editElement.scrollHeight - editElement.clientHeight);
            editElement.scrollTo(0, targetY);
        });
    };
